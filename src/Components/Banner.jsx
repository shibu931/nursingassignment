            ...
            <div className="hero-banner position-relative pb-5">
                <div className="container-fluid px-3 px-md-5">
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="mt-2 mt-md-5">
                                <div className='d-flex flex-column justify-content-center'>
                                    <h1 className='fw-500  title-text mb-4 p-3 p-lg-0 mt-4 mb-lg-4 text-sm-start text-center'>Worried About Nursing<br className='d-none d-lg-block'/> Assignment? Hire Nursing<br className='d-none d-lg-block'/>Assignment Expert</h1>
                        ...
                        <div className="col-lg-4 d-flex justify-content-center ps-0 ps-lg-3 pb-5 pb-lg-0 pt-2">
                            <EmbedForm/>
                        </div>
                    </div>
                </div>
