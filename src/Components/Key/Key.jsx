...
<img
                ...
                />
    <h3 className='fs-5 fw-bold'>Crafting extensively-researched and <br/> well-organized assignments</h3>
    
    <p className='pe-4'>An expert in nursing assignments is meticulous in ensuring that the work is well-crafted, comprehensive, and original. They ensure that the tasks provided are adapted to the individual student's needs and submitted within the given timeframe.</p>
...
<img
                ...
                />
    <h3 className='fs-5 fw-bold'>Effective Communication</h3>
   <p className='pe-4'>An expert in the field of nursing assignment is adept at responding to clients' inquiries and worries in an expeditious yet professional fashion, thus developing a relationship of trust, respect, and open communication.</p>
</div>
</div>
